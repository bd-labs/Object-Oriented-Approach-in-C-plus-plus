...
void NodeSLList_Test()
{
    ...
    NodeSLList<int> list1;
	cout << "*****************************************************************************" << endl;
	cout << "Testing default constructor" << endl;
	cout << "*****************************************************************************" << endl;
	cout << "Creating NodeSLList<int> list1" << endl;
    cout << "cout << list1 " << endl;
	cout << list1 << endl << endl;

    ListNode<int> temp;
	
	ListNode<int> add_tail;
	add_tail.data=60;

	ListNode<int> insert_node;
	insert_node.data=45;
	...
	cout << "*****************************************************************************" << endl;
	NodeSLList<int> list2(list1);
    cout << "cout << list2 " << endl;
	cout << list2 << endl;
	NodeSLList<int> list3(list1);
	cout << "*****************************************************************************" << endl;
